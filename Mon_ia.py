...
# 2. CSS "BLINDÉ" POUR LE DÉPLOIEMENT (Zéro Rouge, Zéro Logo, Style Image 3)
force_css = """
    <style>
    /* FORCER LE MODE CLAIR ET FOND BLANC */
    .stApp, [data-testid="stAppViewContainer"] {
        background-color: white !important;
        color: #1E1E1E !important;
    }

    /* MASQUER TOUS LES ÉLÉMENTS STREAMLIT (MENU, HEADER, FOOTER, BOUTON DEPLOY) */
    header, footer, #MainMenu, .stDeployButton, [data-testid="stHeader"], [data-testid="stToolbar"] {
        visibility: hidden !important;
        display: none !important;
    }

    /* REMONTER LE CONTENU POUR ÉVITER LE VIDE EN HAUT */
    .block-container {
        padding-top: 2rem !important;
    }

    /* DESIGN DU CADRE (HEADER) - RÉPLIQUE EXACTE IMAGE 3 */
    .header-box {
    ...
    /* SUPPRESSION RADICALE DU ROUGE SUR L'INPUT */
    /* On force la bordure en bleu marine au repos */
    [data-testid="stChatInput"] {
        border: 1px solid #0E2A47 !important;
        border-radius: 10px !important;
    }

    /* On force la bordure en bleu marine quand on clique dedans (Focus) */
    .stChatInput:focus-within {
        border-color: #0E2A47 !important;
        box-shadow: 0 0 0 1px #0E2A47 !important;
    }

    /* Couleur de l'icône d'envoi (Avion) en Bleu Marine */
    button[data-testid="stChatInputSubmitButton"] svg {
        fill: #0E2A47 !important;
    }

    /* Fix pour le texte des messages (pour qu'il ne soit jamais blanc sur blanc) */
    ...
    @media (max-width: 640px) {
        .header-box h1 { font-size: 22px !important; }
        .header-box { padding: 25px 15px !important; }
    }
    </style>
"""
st.markdown(force_css, unsafe_allow_html=True)
