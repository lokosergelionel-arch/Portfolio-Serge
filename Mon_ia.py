...
# 2. CSS POUR CACHER LES ÉLÉMENTS (Menu, Footer, Header)
hide_css = """
    <style>
    /* Cacher le menu burger, le footer et le header */
    #MainMenu, footer, header, [data-testid="stHeader"], [data-testid="stToolbar"] {
        visibility: hidden;
        display: none !important;
    }

    /* Cacher le bouton 'Hosted with Streamlit' (specifique mobile) */
    .viewerBadge_container__1QSob, div[class^='viewerBadge_container'] {
        display: none !important;
    }
